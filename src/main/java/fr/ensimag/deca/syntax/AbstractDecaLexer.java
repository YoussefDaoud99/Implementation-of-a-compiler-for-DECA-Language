...
public abstract class AbstractDecaLexer extends Lexer {
    ...
    void Unterminated_String() throws UnterminatedString{
    	throw new UnterminatedString(this, getInputStream());
    }
    
    void Bad_Include() throws BadInclude{
    	throw new BadInclude(this, getInputStream());
    }
    
    void Illegal_Character() throws IllegalCharacter{
    	throw new IllegalCharacter(this, getInputStream());
    }

    void Bad_Comment() throws IllegalCharacter{
    	throw new BadComment(this, getInputStream());
    }
    /**
